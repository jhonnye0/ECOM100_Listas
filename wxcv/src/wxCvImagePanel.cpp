...
BEGIN_EVENT_TABLE(wxCvImagePanel, wxPanel)
// some useful events
/*
...
// catch paint events
                EVT_PAINT(wxCvImagePanel::paintEvent)
//Size event
                EVT_SIZE(wxCvImagePanel::OnSize)
END_EVENT_TABLE()
...
void wxCvImagePanel::paintEvent(wxPaintEvent & evt)
{
 ...
 */
void wxCvImagePanel::OnSize(wxSizeEvent& event){
    Refresh();
    //skip the event.
    event.Skip();
}
